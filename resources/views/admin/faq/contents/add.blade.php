                                ...
                                <div class="row">
                                    ...
                                    @foreach (allLanguage() as $al)
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1" name="question_{{$al->prefix}}" placeholder="{{__('Enter question')}}">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="exampleInputEmail1">{{__('Answer')}} ({{$al->name}})</label>
                                            <textarea name="answer_{{$al->prefix}}" class="form-control" placeholder="{{__('Enter answer')}}"></textarea>
                                        </div>
                                        <div class="col-md-12">
                                            <hr>
                                        </div>
