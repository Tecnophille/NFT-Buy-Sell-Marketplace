...
<div class="col-12 col-md-4 col-lg-3">
    <div class="search-sidebar-wrap user-profile-sidebar-wrap">
        ...
        <div class="user-profile-sidebar-follow-box">
            <button class="menu-round-btn theme-border" id="goToServiceCreate" data-id="{{route('service_create')}}" data-toggle="tooltip" data-placement="top" title="{{__('main.Upload')}}">
        ...
        <div class="membership-status">{{__('main.Member since')}} {{\Carbon\Carbon::parse(Auth::user()->created_at)->format('j M, Y')}}</div>
    </div>
</div>
