    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-4">
        <div class="explore-item">
            <div class="artist-img position-relative">
                <img src="{{cdnAsset(IMG_SERVICE_PATH,$st->thumbnail)}}" alt="explore-img" class="img-fluid">
            ...
            <div class="explore-content">
                ...
                <div class="explore-small-box d-flex align-items-center justify-content-between">
                    ...
                    <p class="font-medium top-artist-stock-qty">{{round($st->available_item)}} {{__('main.in stock')}}</p>
                </div>
            </div>
        </div>
    </div>
