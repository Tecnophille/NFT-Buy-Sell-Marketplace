            ...
            <div class="row page-banner-top-space">
                <div class="col-12 col-lg-12">
                    <div class="page-banner-content text-center">
                        <h1 class="page-banner-title">{{__('main.Selling Method')}}</h1>
                        <p class="page-banner-para">{{__('main.Choose different options for selling your collectible, you can sell at fixed price, auction and in a group.')}}
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                    <a href="{{route('userServiceCreate', encrypt(FIXED_PRICE))}}" class="upload-box-item">
                        <div class="upload-box-inner">
                            ...
                            <h3>{{__('main.Set Price')}}</h3>
                            <p>{{__('main.Sell at fixed price')}}</p>
                        </div>
                    </a>
                </div>
                <!-- Upload Box End -->
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                    <a href="{{route('userServiceCreate', encrypt(BID_PRICE))}}" class="upload-box-item">
                        <div class="upload-box-inner">
                            ...
                            <h3>{{__('main.Highest Bid')}}</h3>
                            <p>{{__('main.Sell through Auction')}}</p>
                        </div>
                    </a>
                </div>
                <!-- Upload Box End -->
                <div class="col-12">
                    <p class="upload-user-private-text text-center">{{__('We do not own your private keys and cannot access your funds without your confirmation.')}}</p>
                </div>
            </div>
        </div>
    </section>
