...
@section('content')
                    ...
                    <div class="search-rightside-area">
                        <div class="table-responsive">
                            <table id="serviceList" class="table table-striped table-bordered data-table display responsive">
                                <thead>
                                <tr>
                                    <th class="all">{{__('main.Coin Name')}}</th>
                                    <th class="all">{{__('main.Type')}}</th>
                                    <th class="none">{{__('main.Address')}}</th>
                                    <th class="all">{{__('main.Balance')}}</th>
                                    <th class="all">{{__('main.On Hold Balance')}}</th>
                                    <th class="all">{{__('main.Last Update')}}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="d-flex justify-content-center align-items-center my-wallet-actions-btn">
                                                    <li>
                                                        <button data-toggle="modal" data-wallet_id="{{$wallet->id}}" data-address="{{$wallet->address}}" data-coin="{{$wallet->coin->coin_type}}" href="#depositModal"  title="{{__('main.Deposit')}}" class="deposit-btn btn btn-success"><i class="fas fa-arrow-down"></i> </button>
                                                    </li>
                                                    <li>
                                                        <button data-toggle="modal" data-wallet_id="{{$wallet->id}}"  title="{{__('main.withdraw')}}" data-coin="{{$wallet->coin->coin_type}}" class="withdrawal-btn btn btn-danger" href="#withdrawalModal"><i class="fas fa-arrow-up"></i> </button>
                                                    </li>
                                                    <li>
                                                        <a href="{{route('activity_log', $wallet->coin_id)}}" title="{{__('main.Activity log')}}" class="btn btn-info"><i class="fas fa-list"></i> </a>
                                                    </li>
                                                </ul>
                                            </td>
                                        </tr>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header p-0">
                    <h4 class="deposit-header modal-title">{{__('main.Calculating...')}}</h4>
                    <span class="fas fa-close">
                    </span>
                </div>
                <div class="modal-body p-0">
                    <div class="deposit-modal-content">
                        <p class="pb-3">{{__('main.Please use this Coin exactly as displayed')}}</p>
                        ...
                        <div class="creator-not-verified d-flex justify-content-center align-items-center mb-0">
                            ...
                            <div class="creator-not-verified-right">
                                <p class="font-medium note noteDanger">{{__('main.Calculating...')}}</p>
                                <p class="font-12 paraText send-text">{{__('main.others-currency-to-text')}}</p>
                            </div>
                        </div>
    ...
    <div class="modal fade common-modal" id="withdrawalModal" tabindex="-1" aria-labelledby="withdrawalModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header p-0">
                    <h4 class="withdrawal-header modal-title">{{__('main.Calculating...')}}</h4>
                    <span class="fas fa-close">
                    </span>
                </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12 col-lg-12">
                                    <input class="w-address form-control" placeholder="{{__('main.Address')}}" name="address" type="text" required>
                                </div>
                                <div class="col-12 col-lg-12">
                                    <input class="w-amount form-control" placeholder="{{__('main.Amount')}}" name="amount" type="text" required>
                                </div>
                                <div class="col-12 pt-3">
                                    <div class="creator-not-verified d-flex justify-content-center align-items-center mb-0">
                                        <div class="creator-not-verified-left"><i class="fas fa-exclamation"></i></div>
                                        <div class="creator-not-verified-right">
                                            <p class="font-medium paraText w-notice">{{__('main.Note : You Are About To withdrawal')}}</p>
                                            <p class="font-12 paraText">{{__('main.others-currency-to-text')}}</p>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade common-modal" id="withdrawalConfirmModal" tabindex="-1" aria-labelledby="withdrawalConfirmModal" data-backdrop="static" data-keyboard="false" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header p-0">
                    <h4 class="withdrawal-confirm-header modal-title">{{__('main.Put the code below')}}</h4>
                    <span class="fas fa-close">
                    </span>
                </div>
                <div class="modal-body wc-ajax-alert">
                    {{Form::open(['route' => 'withdrawal_two_fa_coin', 'files' => true, 'data-handler'=>"showMessage" ,'class' => 'ajax'])}}
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12 col-lg-12">
                                    <input class="w-code form-control" placeholder="{{__('main.Code Here')}}" name="w-code" type="text" required>
                                    <input id="w-hash" class="w-hash form-control"  name="w-hash" type="hidden">
                                </div>
                                <div class="col-12 pt-3">
                                    <span class="paraText wc-notice"> {{__('main.check your email and put the following code here')}} </span>
