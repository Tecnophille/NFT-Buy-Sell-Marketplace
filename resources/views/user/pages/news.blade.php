                        ...
                        @if($loop->first)
                            <div class="news-list-item">
                                <div class="card news-item">
                                    <a href="{{route('news_details', $an->translateOrDefault(Session::get('locale'))->slug)}}" class="box-bg-image" data-background="{{cdnAsset(IMG_NEWS_PATH,$an->thumbnail)}}">
                                        <img src="{{cdnAsset(IMG_NEWS_PATH,$an->thumbnail)}}" alt="{{__('main.news')}}" class="img-fluid">
                                    </a>
                                    <div class="card-body">
                                        <div class="news-publish-date color-green fw-bold">{{\Carbon\Carbon::parse($an->created_at)->format('F j, Y')}}</div>
                                        <h3 class="news-title"><a href="{{route('news_details', $an->slug)}}">{{$an->translateOrDefault(Session::get('locale'))->title}}</a></h3>
                                        <p class="card-text">{!! clean(Str::limit($an->translateOrDefault(Session::get('locale'))->description, 200, '...'))!!} <a href="{{route('news_details', $an->translateOrDefault(Session::get('locale'))->slug)}}" class="news-read-more font-weight-bold">{{__('main.Read More')}}</a></p>
                                    </div>
                                </div>
                            </div>
                        @endif
                    ...
                    @foreach($all_news as $ant)
                        @if ($loop->iteration == 2)
                            <div class="news-list-item news-item-small">
                                <div class="card news-item">
                                    <a href="{{route('news_details', $ant->translateOrDefault(Session::get('locale'))->slug)}}" class="box-bg-image" data-background="{{cdnAsset(IMG_NEWS_PATH,$ant->thumbnail)}}">
                                        <img src="{{cdnAsset(IMG_NEWS_PATH,$ant->thumbnail)}}" alt="{{__('main.news')}}" class="img-fluid">
                                    </a>
                                    <div class="card-body">
                                        <div class="news-publish-date color-green fw-bold">{{\Carbon\Carbon::parse($ant->created_at)->format('F j, Y')}}</div>
                                        <h3 class="news-title"><a href="{{route('news_details', $ant->slug)}}">{{$ant->translateOrDefault(Session::get('locale'))->title}}</a></h3>
                                        <p class="card-text">{!!clean(Str::limit($ant->translateOrDefault(Session::get('locale'))->description, 100, '...'))!!} <a href="{{route('news_details', $ant->translateOrDefault(Session::get('locale'))->slug)}}" class="news-read-more font-weight-bold">{{__('main.Read More')}}</a></p>
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        @if ($loop->iteration == 3)
                            <div class="news-list-item news-item-small">
                                <div class="card news-item">
                                    ...
                                    <div class="card-body">
                                        <div class="news-publish-date color-green fw-bold">{{\Carbon\Carbon::parse($ant->created_at)->format('F j, Y')}}</div>
                                        <h3 class="news-title"><a href="{{route('news_details', $ant->translateOrDefault(Session::get('locale'))->slug)}}">{{$ant->title}}</a></h3>
                                        <p class="card-text">{!!clean(Str::limit($ant->translateOrDefault(Session::get('locale'))->description, 100, '...'))!!} <a href="{{route('news_details', $ant->translateOrDefault(Session::get('locale'))->slug)}}" class="news-read-more font-weight-bold">{{__('main.Read More')}}</a></p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="hot-news-area">
                        <h2 class="section-heading">{{__('main.Hot News')}}</h2>
                                    ...
                                    <div class="news-list-item news-item-small hot-news-item">
                                        <div class="card news-item d-flex">
                                            <div class="col-12 col-md-5 col-lg-5">
                                                <a href="{{route('news_details', $anh->translateOrDefault(Session::get('locale'))->slug)}}" class="box-bg-image" data-background="{{cdnAsset(IMG_NEWS_PATH,$anh->thumbnail)}}">
                                                    <img src="{{cdnAsset(IMG_NEWS_PATH,$anh->thumbnail)}}" alt="{{__('main.news')}}" class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="card-body col-12 col-md-8 col-lg-7">
                                                ...
                                                <h3 class="news-title"><a href="{{route('news_details', $anh->translateOrDefault(Session::get('locale'))->slug)}}">{{$anh->translateOrDefault(Session::get('locale'))->title}}</a></h3>
                                                <div class="card-text">{!!clean(Str::limit($anh->translateOrDefault(Session::get('locale'))->description, 105, '...'))!!} <a href="{{route('news_details', $anh->translateOrDefault(Session::get('locale'))->slug)}}" class="news-read-more font-weight-bold">{{__('main.Read More')}}</a></div>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                            ...
                            <div class="news-list-item news-item-small trending-news-item">
                                <div class="card news-item">
                                    <div class="card-body">
                                        ...
                                        <h3 class="news-title"><a href="{{route('news_details', $antt->translateOrDefault(Session::get('locale'))->slug)}}">{{$antt->translateOrDefault(Session::get('locale'))->title}}</a></h3>
                                        {!!clean(Str::limit($anh->translateOrDefault(Session::get('locale'))->description, 50, '...'))!!}
                                    </div>
                                </div>
                            </div>
                            @endif
