            ...
            <div class="row page-banner-top-space">
                <div class="col-12 col-lg-12">
                    <div class="page-banner-content text-center">
                        <h1 class="page-banner-title">{{__('main.2FA Verification')}}</h1>
                        <p class="page-banner-para">{{__('main.2fa-enable-message')}}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb" class="breadcrumb-area">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{__('main.2FA Verification')}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                ...
                <!-- Reset Password Form -->
                    <div class="form-group">
                        <input class="form-control" placeholder="{{__('main.One Time Password')}}" name="token" type="text" required>
                    </div>
