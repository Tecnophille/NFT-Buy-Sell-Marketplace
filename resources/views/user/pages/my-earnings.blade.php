        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-8 col-lg-9">
                    <h1 class="page-banner-title mb-4">{{__('main.Fixed Purchase Earnings - ').visual_number_format($purchase_earning).__(' USD')}}</h1>
                    <div class="search-rightside-area">
                        <div class="table-responsive">
                            <table id="serviceList" class="user-dashboard-table table table-striped table-bordered data-table display responsive">
                                <thead>
                                <tr>
                                    <th class="all">{{__('main.Artwork')}}</th>
                                    <th class="all">{{__('main.Thumb')}}</th>
                                    <th class="all">{{__('main.Buyer')}}</th>
