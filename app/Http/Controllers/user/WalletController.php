...
class WalletController extends Controller
{
    ...
    public function depositData(Request $request)
    {
        ...
        return view('user.pages.deposit-data', ['title' => __('main.Deposit History'), 'menu' => 'deposit-data']);
    }
    public function activityLog(Request $request, $coin_id)
    {
        ...
        return view('user.pages.activity-log', ['title' => __('main.Activity Log'), 'menu' => 'my-wallet', 'coin_id' => $coin_id]);
    }
    ...
    public function myEarnings(Request $request)
    {
        ...
        return view('user.pages.my-earnings', ['title' => __('main.My Earnings'), 'menu' => 'my-earnings', 'purchase_earning' => $purchase_earning, 'bid_earning' => $bid_earning]);
    }
    ...
    public function withdrawData(Request $request)
    {
        ...
        return view('user.pages.withdraw-data', ['title' => __('main.Withdraw History'), 'menu' => 'withdraw-data']);
    }
}
